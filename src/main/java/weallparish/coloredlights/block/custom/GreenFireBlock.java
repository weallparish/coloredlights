...
public class GreenFireBlock extends FireBlock {
    ...
    public static boolean isMossBase(BlockState state) {
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        System.out.println("placing green fire block!");
        return GreenFireBlock.isMossBase(world.getBlockState(pos.down()));
    }
